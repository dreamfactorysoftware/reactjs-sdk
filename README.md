...
- Edit your app API key
    ...
    - If you are running locally edit app/components/Main.js in your local repo.
...
The Address Book for JavaScript [here](https://github.com/dreamfactorysoftware/javascript-sdk) can also be useful for inspiration.
